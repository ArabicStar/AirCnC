...
public class HotelManagePromotionManagerImpl implements HotelManagePromotionManager{

private static HotelManagePromotionManager instance;
	
	private List<HotelPromotionVo> promotions;

	
	public static final HotelManagePromotionManager launch() {
		if (instance != null)
			throw duplicateSingletonEx();

		return instance = new HotelManagePromotionManagerImpl();
	}
	
	public static final HotelManagePromotionManager getInstance(){
		if (instance == null)
