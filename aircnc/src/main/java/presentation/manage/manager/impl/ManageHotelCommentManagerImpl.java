...
public class ManageHotelCommentManagerImpl implements ManageHotelCommentManager {
	...
	private ObservableList<ManageCommentModel> commentData;
	...
	public void test() {
		...
		builder.setContent("这边真好玩，就当我完了一晚上鬼屋了，还特别便宜，隔壁有几个男生叫了一晚上，胆子真小啊。").setCheckInTime(LocalDate.of(2016, 8, 20))
				.setMemberID("47263544").setMemberLevel(5).setGrade(5);
		comments.add(builder.getCommentInfo());
