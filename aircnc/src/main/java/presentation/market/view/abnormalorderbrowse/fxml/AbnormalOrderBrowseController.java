...
public class AbnormalOrderBrowseController implements Initializable {
	...
	public void test() {
		...
		operation.setCellValueFactory(
				new Callback<TableColumn.CellDataFeatures<OrderModel, ButtonName>, ObservableValue<ButtonName>>() {
		...
		operation
				.setCellFactory(new Callback<TableColumn<OrderModel, ButtonName>, TableCell<OrderModel, ButtonName>>() {
