...
public abstract class HotelPeriodTrigger extends HotelTrigger {

	private LocalDateTime from, to;

	public HotelPeriodTrigger(LocalDateTime from, int durationDays) {
		this(from, from.plusDays(durationDays - 1));
	}

	public HotelPeriodTrigger(LocalDateTime from, LocalDateTime to) {
		super(When.PEROID);
